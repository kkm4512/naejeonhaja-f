<template>
 ...
 onMounted(() => {
  ...
  const saveTeam = async() => {
    const response = await uFetch<LolPlayerResultHistoryRequestDto,ApiResponse<null>>(riftPlayerResultHistoryRequestDto.value,"/game/lol/abyss/playerResultHistory","POST",true);
