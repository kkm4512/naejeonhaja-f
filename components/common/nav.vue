  ...
  <nav class="bg-black border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">내전하자</span>
      </a>
      <!-- 모바일 메뉴 버튼 -->
      <button
      ...
      >
        <ul
          class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-black md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-black dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
        >
          <li class="relative">
            <!-- LOL -->
            <a
            ...
            <ul
              ...
              class="absolute left-0 mt-2 w-40 bg-black rounded-md shadow-lg dark:bg-gray-800"
            >
              <li>
                <a
                  href="/game/lol/rift"
                  class="block px-4 py-2 text-white hover:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                >
                  소환사의 협곡
                </a>
              </li>
          ...
          <li>
            ...
            <a
              v-if="!jwt"
              href="/user/signin"
              class="block py-2 px-3 text-white rounded hover:bg-gray-800 md:hover:bg-transparent md:border-0 md:hover:text-blue-500 md:p-0 dark:text-white dark:hover:text-blue-500 dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
            >
              로그인
            </a>
            <span
              v-else
              class="flex items-center space-x-3 text-white py-2 px-3 rounded hover:bg-gray-800 md:hover:bg-transparent md:border-0 md:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
            >
              {{ nickname }} 님 환영합니다
              <button
                @click="logout()"
                class="ml-4 block py-2 px-3 text-white rounded hover:bg-gray-800 md:hover:bg-transparent md:border-0 md:hover:text-blue-500 md:p-0 dark:text-white dark:hover:text-blue-500 dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
              >
                로그아웃
              </button>
            </span>
